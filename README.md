...
- **`RemoteTafsirDataSource`** — واجهة Quran.com الرسمية (v4): تفسير
  السعدي وابن كثير والطبري والقرطبي بالعربية، مع تنظيف نصوص HTML.
- **`LocalTafsirDataSource`** — سجل كتب التفسير المعتمدة الخمسة
  (يشمل الجلالين بانتظار مصدر عربي) وعينات حقيقية من تفسير السعدي
  مضمَّنة في `lib/assets_data/tafsir/` كاحتياطي دون اتصال.
- **`TafsirRepositoryImpl`** — النص بعيد أولاً مع العودة للمحلي،
  والسجل من البيانات المضمَّنة، مع ذاكرة مؤقتة داخل الجلسة.

الميزات: «عرض التفسير» من ورقة إجراءات أي آية · اختيار كتاب التفسير ·
